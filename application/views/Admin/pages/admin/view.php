...
<div class="card card-custom">
	<div class="card-header flex-wrap py-5">
		<div class="card-title">
			<h3 class="card-label">Data Admin Active 
				<span class="d-block text-muted pt-2 font-size-sm">Configurasi Data Admin</span></h3>
			</div>
			<div class="card-toolbar">

				<!--begin::Button-->
				<a href="<?= site_url('Admin/AdminConf/form') ?>" class="btn btn-primary font-weight-bolder">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2" onclick="deleteThs(this);" data-url="<?= site_url('Admin/AdminConf/delete/'.base64_encode($key['id_admin']).'/'.$key['nama_admin']) ?>" title="Delete"><i class="fas fa-trash trash"></i></a> 
							</td>
						</tr>
					<?php endforeach ?>
				</tbody>
	...
	<script src="<?= base_url('assets/') ?>dist/assets/js/pages/crud/datatables/basic/paginations526f.js?v=7.0.8"></script>

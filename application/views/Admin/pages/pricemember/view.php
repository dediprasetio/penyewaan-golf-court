...
<div class="card card-custom gutter-b">
	<div class="card-header flex-wrap py-3">
		<div class="card-title">
			<h3 class="card-label">Data Price Member 
				<span class="d-block text-muted pt-2 font-size-sm">Price yang di sediakan untuk Member</span></h3>
			</div>
			<div class="card-toolbar">

				<!--begin::Button-->
				<?php if (count($data['data']['result']) < 1): ?>
					
				<a href="<?= site_url('Admin/Price/form') ?>" class="btn btn-primary font-weight-bolder">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<a href="<?= site_url('Admin/Price/form/'.base64_encode($key['id_price'])) ?>" class="font-blue-in-here"><i class="fas fa-edit edit"></i></a>

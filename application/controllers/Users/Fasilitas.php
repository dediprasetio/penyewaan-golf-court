...
class Fasilitas extends CI_Controller {
	...
	public function index()
	{
		...
		$dt = $this->fasilitas->showDetail(['id_fasilitas' => $record['fasilitas']->id_fasilitas])->result_array();
		$record['detailFasilitas'] = $dt;

		$data['data'] = $this->description("Fasilitas Member Users | Booking Golf Hall", "Fasilitas Member", "fasilitas", $record, "Fasilitas yang di dapat ketika menjadi member");
		
		$data['content'] = "Users/pages/fasilitas";
...
/* Location: ./application/controllers/Users/Fasilitas.php */